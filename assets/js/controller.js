var myapp = angular.module("myapp", ["firebase", "ngRoute", "ngSanitize", "ngAnimate", "textAngular"]);
...
//scenario, narrative, decisionOption management
	...
	$scope.addScenario = function() {
		...
		myScenario.child('timesPlayed').set(0);
	...
	$scope.addDecisionOption = function() {	
		...
		myDecisionOption.child('nextStep').set($scope.selectNextNarrative);
	...
	$scope.exitScenario = function() {
		$scope.scenarioLoaded = "N";
	};
